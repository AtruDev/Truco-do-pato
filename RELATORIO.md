...
**Equipe:** Lucca, Rafael, Pedro, Joao e Arthur

## 1. Participação de cada componente

| Componente | Módulo | Arquivos | O que foi feito |
|---|---|---|---|
| **Lucca** | 1 · Jogadores, duplas e mesa | `include/jogador.h`, `src/jogador.c` | Structs `Jogador`, `Dupla` e `Mesa`. Cadastro do jogador com o nome truncado com segurança, ligação de mão dupla entre jogador e dupla, e montagem da mesa alternando as duplas (D1, D2, D1, D2). |
